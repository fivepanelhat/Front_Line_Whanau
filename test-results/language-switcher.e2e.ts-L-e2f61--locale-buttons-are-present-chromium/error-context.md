...
- Name: language-switcher.e2e.ts >> Language switcher >> both locale buttons are present
- Location: e2e\language-switcher.e2e.ts:23:7
...
Locator: locator('#language-switcher').getByRole('button', { name: /en/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#language-switcher').getByRole('button', { name: /en/i })
