...
- Name: language-switcher.e2e.ts >> Language switcher >> language switcher is visible on the home page
- Location: e2e\language-switcher.e2e.ts:14:7
...
Locator: locator('#language-switcher')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#language-switcher')
