...
- Name: role-selection.e2e.ts >> Role selection >> navigating back from portal returns to home
- Location: e2e\role-selection.e2e.ts:32:7
  ...
  - banner [ref=e2]:
    - generic [ref=e3]:
      - link "Front Line Whānau" [ref=e4] [cursor=pointer]:
        - /url: /en-NZ
      - navigation [ref=e5]:
        - link "Directory" [ref=e6] [cursor=pointer]:
          - /url: /en-NZ/directory
      ...
      - generic [ref=e9]:
        - generic [ref=e10]:
          - button "Switch to English (NZ)" [ref=e11] [cursor=pointer]: English (NZ)
          - button "Switch to Te Reo Māori" [ref=e12] [cursor=pointer]: Te Reo Māori
        - button "Log in" [ref=e13] [cursor=pointer]
  - main [ref=e14]:
    - heading "Support for whānau of preterm twins" [level=1] [ref=e15]
    - paragraph [ref=e16]: Private. Culturally safe. Built for Aotearoa.
    - generic [ref=e17]:
      - link "Browse Directory" [ref=e18] [cursor=pointer]:
        - /url: /directory
      - link "View Resources & Guides" [ref=e19] [cursor=pointer]:
        - /url: /resources
