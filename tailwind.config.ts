...
const config: Config = {
 ...
 glass:
 '0 8px 32px rgba(0, 0, 0, 0.12), 0 1px 0 rgba(255, 255, 255, 0.12) inset',
 'glass-lg':
 '0 24px 64px rgba(0, 0, 0, 0.2), 0 1px 0 rgba(255, 255, 255, 0.14) inset',
 },
 ...
 'gradient-subtle':
 'linear-gradient(180deg, rgba(53,128,108,0.1) 0%, transparent 100%)',
 'hero-radial':
