...
export const CONSENT_DESCRIPTIONS: Record<ConsentScope, {
 title: string;
 description: string;
 dataAccessed: string;
 ...
 description: 'Back up your encrypted journal entries to the server. Data remains encrypted - the server cannot read your entries.',
 ...
 'ai.process': {
 title: 'AI Analysis',
 description: 'Allow the AI assistant to analyse information you share to provide personalised guidance. Your data is processed locally where possible.',
 dataAccessed: 'Conversation content and context',
 riskLevel: 'medium',
 },
 'ai.execute': {
 title: 'AI-Assisted Actions',
 description: 'Allow the AI to prepare forms, draft documents, and suggest actions on your behalf. You always review before anything is finalised.',
