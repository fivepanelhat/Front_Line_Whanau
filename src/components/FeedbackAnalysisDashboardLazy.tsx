...
export const FeedbackAnalysisDashboard = dynamic(
  ...
  {
    loading: () => (
      <div className="border-border bg-bg-secondary flex h-64 w-full items-center justify-center rounded-lg border">
        <p className="text-text-muted text-sm">Loading feedback analysis...</p>
      </div>
    ),
    ssr: false,
  },
