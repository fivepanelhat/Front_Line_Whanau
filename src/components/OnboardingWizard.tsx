...
export function OnboardingWizard({ onComplete }: { onComplete: () => void }) {
 ...
 You are among the first to test the <strong>Front Line Whanau AI</strong>, an intelligent assistant specifically designed to help Aotearoa parents navigate the NICU journey.
 </p>
 <p className="text-gray-600 text-lg">
 ...
 <p><strong>Your Voice Matters:</strong> Your feedback (using the thumbs up/down buttons on messages) actively helps us improve the system for all whanau.</p>
 </div>
 <div className="flex gap-4 items-start">
 ...
 I understand this is an experimental AI, not a doctor. I consent to my anonymized chat data being reviewed by the Front Line Whanau clinical team for safety improvements.
 </span>
 </label>
 </div>
