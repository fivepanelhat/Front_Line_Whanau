...
export function ChatInterface() {
  ...
  return (
    <div className="relative flex h-full flex-col overflow-hidden">
      <div
        aria-hidden
        className="liquid-orb liquid-orb--teal pointer-events-none absolute top-10 -left-20 h-72 w-72 opacity-40"
      />
      <div
        aria-hidden
      ...
      <div className="shadow-glass-lg relative z-10 mx-3 mt-2 mb-3 flex h-[calc(100dvh-5.5rem)] overflow-hidden rounded-3xl border border-white/10 sm:mx-4 sm:mb-4">
        <div className="bg-bg-secondary/40 flex min-h-0 w-full backdrop-blur-2xl">
          <ConversationSidebar
