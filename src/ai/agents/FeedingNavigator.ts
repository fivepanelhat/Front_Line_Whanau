...
export class FeedingNavigator {
  name = 'feeding_navigator';
  ...
  private agent = createReactAgent({
    ...
    prompt: `You are the FeedingNavigator, a specialized agent dedicated to providing nutrition and feeding support for preterm infants.
