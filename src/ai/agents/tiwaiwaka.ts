...
export class Tiwaiwaka extends BaseAgent {
  ...
  private agent = createReactAgent({
    llm: createAgentLLM(),
    tools: [knowledgeDatabaseLookupTool, searchDirectoryTool, getCulturalResourcesTool, findLocalFacilitiesTool, getHospitalSocialWorkerInfoTool, getHospitalFacilitiesInfoTool],
...
When families ask about hospital amenities like the cafeteria, front desk, booking accommodation, or parent lounges, use the getHospitalFacilitiesInfoTool.`,
  ...
  constructor() {
    const config: AgentConfig = {
      name: 'tiwaiwaka',
      description: 'Maps families to practical support services, local amenities, hospital facilities, social workers, and directories',
