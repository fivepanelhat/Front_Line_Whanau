...
const NEED_KEYWORDS: Record<NeedArea, string[]> = {
 ...
 partner_org: ['our organisation', 'our service', 'referral pathway', 'we support whanau', 'we support whanau'],
};
...
const PLAY_LIBRARY: Record<NeedArea, Omit<Play, 'whyThisMatters'>> = {
 ...
 steps: [
 { action: 'Ask your unit about its whanau room and how tikanga can be supported on the ward.', effort: 'one question' },
 { action: 'Connect with a Whanau Ora navigator to bring kaupapa Maori support alongside clinical care.', effort: 'one phone call' },
 ],
 ...
 reviewRequired: true,
 integrationHint: 'The hub\'s cultural navigator can help find kaupapa Maori services in your rohe.',
 },
 twins_multiples: {
 ...
 steps: [
 { action: 'Map which of your services are reachable by rural whanau without travel.', effort: '30 min' },
