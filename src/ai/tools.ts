...
export const getHospitalSocialWorkerInfoTool = createSafeTool(
 ...
 return {
 overview: "Hospital Social Workers are free, confidential, and specialized in supporting whanau.",
 ...
 return {
 overview: "Hospital Social Workers are free, confidential, and specialized in supporting whanau during their hospital stay.",
 services: [
...
export const getHospitalFacilitiesInfoTool = createSafeTool(
 ...
 description: "Provides information about common hospital facilities, such as the cafeteria, front desk reception, booking accommodation (whanau rooms), parent lounges, showers, food options, and transport (drop-off zones, Ubers, taxis, buses).",
 schema: z.object({
 ...
 accommodation: "To book a room or hospital accommodation (such as a Ronald McDonald House, whanau room, or hospital flat), you usually cannot book directly at reception. You must speak to a Hospital Social Worker or the NICU Charge Nurse who will submit a referral based on availability and criteria (like how far you live from the hospital).",
 ...
 showers: "Whanau showers are usually available in or near the NICU or maternity ward. Ask your bedside nurse where they are located. You may need to bring your own toiletries, though some wards can provide towels.",
 ...
 return {
 overview: "Hospitals in Aotearoa provide various facilities to support whanau during their stay.",
