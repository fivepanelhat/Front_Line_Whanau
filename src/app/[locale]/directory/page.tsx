...
export default async function DirectoryPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <div
        aria-hidden
        className="liquid-orb liquid-orb--teal pointer-events-none absolute top-0 -left-16 h-80 w-80 opacity-60"
      />
      <div
        aria-hidden
        className="liquid-orb liquid-orb--amber pointer-events-none absolute top-32 -right-10 h-72 w-72 opacity-50"
      />

      <div className="relative px-4 pt-10 pb-6 sm:px-6 sm:pt-14 sm:pb-10">
        <div className="glass-card mx-auto max-w-6xl overflow-hidden rounded-3xl p-6 sm:p-10">
          ...
          <h1 className="text-text-primary mb-3 text-2xl font-bold tracking-tight sm:mb-4 sm:text-4xl">
            National Directory
          </h1>
