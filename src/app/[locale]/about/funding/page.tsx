export default function FundingPage() {
 ...
 <p>
 Front Line Whanau operates as a not-for-profit initiative. Our primary goal is to remove barriers to access, meaning the platform will <strong>always remain free for parents and whanau</strong>. To achieve this, we rely on a diversified, sustainable funding and operations model.
 </p>
 ...
 <p>
 By utilizing modern, serverless architecture and open-source models, we keep our operational overhead extremely low. This ensures that every dollar funded goes directly into improving the user experience and expanding access to vital resources for preterm whanau.
 </p>
 </div>
 </div>
 );
