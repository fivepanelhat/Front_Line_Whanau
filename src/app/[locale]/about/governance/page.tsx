export default function GovernancePage() {
 ...
 <ul>
 <li><strong>Whanau Representatives:</strong> Parents who have navigated the NICU/SCBU journey across different regions in Aotearoa.</li>
 <li><strong>Clinical Advisors:</strong> Neonatologists and NICU nurses providing medical oversight.</li>
 <li><strong>Maori & Pasifika Cultural Advisors:</strong> Ensuring our platform upholds Te Tiriti o Waitangi and respects Pacific data sovereignty.</li>
 <li><strong>Privacy & Security Experts:</strong> Safeguarding the Taonga Vault encryption models.</li>
 </ul>

 <h3>Te Tiriti o Waitangi</h3>
 <p>
 We are committed to the principles of Te Tiriti o Waitangi. All data collected about Maori is treated as taonga (a treasure) and is subject to Maori data sovereignty principles.
 </p>
 </div>
 </div>
 );
